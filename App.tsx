  ...
  return (
    <div className="min-h-screen bg-brutal-bg p-4 md:p-8 font-mono selection:bg-brutal-red selection:text-white">
      ...
      <header className="mb-12 border-b-8 border-black pb-6 max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <Link to="/blogs" className="w-full md:w-auto">
          <BrutalButton className="w-full md:w-auto bg-black text-brutal-yellow hover:bg-brutal-yellow hover:text-white border-2 border-black">
            READ THE INDUSTRY
          </BrutalButton>
        </Link>
      </header>
      ...
      <footer className="max-w-5xl mx-auto border-t-8 border-black pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="font-mono text-sm">
          <p>© 2024 INTERN_OS. ALL RIGHTS RESERVED.</p>
